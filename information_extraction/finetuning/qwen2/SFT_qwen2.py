...
def main():
    ...
    parser.add_argument("--output_dir",   type=str,   required=False, help="Path where the model will be saved", default="./DrMistral-BioInstructQA-EN-models/")
    parser.add_argument("--logging_dir",  type=str,   required=False, help="Path where the model will be saved", default="./DrMistral-BioInstructQA-EN-models-logs/")
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.model_name, model_max_length=8192, padding=True)
    ...
    # Load dataset
    ##############
    dataset = load_from_disk(args.path_dataset)
